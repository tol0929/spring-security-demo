...
import static com.example.springsecuritydemo.mbgenerate.crud.RolesDynamicSqlSupport.*;
...
public interface RolesMapper extends CommonCountMapper, CommonDeleteMapper, CommonInsertMapper<Roles>, CommonUpdateMapper {
    ...
    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    default Optional<Roles> selectByPrimaryKey(Integer id_) {
        return selectOne(c ->
            c.where(id, isEqualTo(id_))
        );
    }
    ...
    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    default int updateByPrimaryKey(Roles row) {
        return update(c ->
    ...
    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    default int updateByPrimaryKeySelective(Roles row) {
        return update(c ->
